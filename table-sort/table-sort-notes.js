const artists = [
  ...
  function byName(a, b) {
    ...
    if (a.name > b.name) return 1;
    return 0;
   } // any function that will be used to sort stuff needs to return -1, 0, or 1.
     // -1 means that a comes before b
     // 0 means that a and b are equivalent
     // 1 means that b comes before a
  ...
  function pickArtist() {
    ...
    return artists[randomIndex].name;  // math.random is like runif in R
  }
